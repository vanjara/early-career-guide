# Notion Page: Start Here

PAGE TITLE: 🏠 Start Here

PAGE ICON: 🏠
PAGE COVER: optional — a clean neutral image

---

[H1] Early Career Job Search Guide

A practical resource for tech and business/finance new grads — including OPT/visa candidates.

[CALLOUT] 💡
No hustle content. No paid courses. Just a practical system — what to do, in what order, with templates you can use today.
...
Pick your situation and go straight to what you need.
...
→ Go to: Job Search Strategy

[CALLOUT] 🟠 I'm getting interviews but not converting
You've cleared the resume and application stage — that's already more than most people. Now it's about prep.
...
Don't accept on the spot. Read this first.

→ Go to: Offer & Negotiation + Benefits
...
[H3] Built for friends and contacts. No affiliation with any job board, coaching service, or recruiter.
